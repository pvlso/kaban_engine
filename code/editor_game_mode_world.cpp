...
GetWorldMapGroundTile(world *World, u32 TileX, u32 TileY)
{
...
GetWorldMapGroundTile(world *World, world_position P)
{
    sswm_ground_tile *Result = GetWorldMapGroundTile(World, P.TileX, P.TileY);
    return(Result);
}

inline b32
TileIsValid(world *World, u32 TileX, u32 TileY)
{
    b32 Result = GetWorldMapGroundTile(World, TileX, TileY) ? true : false;
    return(Result);
}

internal world *
CreateWorld(transient_state *TranState, r32 TileSideInMeters, u32 WorldTileWidth, u32 WorldTileHeight, u32 NodesPerTile, loaded_world_map *Map)
{
