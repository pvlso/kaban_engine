...
internal void
BeginInteract(ui_state *UIState, editor_input *Input, v2 MouseP)
{
...
internal void
EndInteract(ui_state *UIState, editor_input *Input, v2 MouseP)
{
...
internal void
Interact(ui_state *UIState, editor_input *Input, v2 MouseP)
{
...
internal void
DrawAssetsModeUI(ui_state *UIState, ui_layout *Layout, editor_mode_assets *AssetsMode)
{
    interaction NullInteraction = {};
    ...
    switch(AssetsMode->EditMode)
    {
        ...
        {
            UIBeginRow(Layout);
            UIButton(Layout, "Edit Bitmaps",
                     UISetUInt32Interaction(InteractionID(UIState), (u32 *)&AssetsMode->EditMode, EditMode_Bitmap),
                     235.0f, BColor_Green, 80.0f);

            UIButton(Layout, "Edit Sounds", 
                     UISetUInt32Interaction(InteractionID(UIState), (u32 *)&AssetsMode->EditMode, EditMode_Sound),
                     235.0f, BColor_Green, 80.0f);

            UIButton(Layout, "Edit SpriteSheets",
                     UISetUInt32Interaction(InteractionID(UIState), (u32 *)&AssetsMode->EditMode, EditMode_SpriteSheet),
                     235.0f, BColor_Green, 80.0f);
            UIEndRow(Layout);

            UIBeginRow(Layout);
            UIButton(Layout, "Edit Tilesets",
                     UISetUInt32Interaction(InteractionID(UIState), (u32 *)&AssetsMode->EditMode, EditMode_Tileset),
                     235.0f, BColor_Green, 80.0f);

            UIButton(Layout, "Edit Fonts",
                     UISetUInt32Interaction(InteractionID(UIState), (u32 *)&AssetsMode->EditMode, EditMode_Font),
                     235.0f, BColor_Green, 80.0f);

            UIButton(Layout, "Edit Texts", 
                     UISetUInt32Interaction(InteractionID(UIState), (u32 *)&AssetsMode->EditMode, EditMode_Text),
                     235.0f, BColor_Green, 80.0f);
            UIEndRow(Layout);

            UIBeginRow(Layout);
            UIButton(Layout, "Edit Files", 
                     UISetUInt32Interaction(InteractionID(UIState), (u32 *)&AssetsMode->EditMode, EditMode_File),
                     235.0f, BColor_Green, 80.0f);
            UIButton(Layout, "Edit SSWM", 
                     UISetUInt32Interaction(InteractionID(UIState), (u32 *)&AssetsMode->EditMode, EditMode_SSWM),
                     235.0f, BColor_Green, 80.0f);
            ...
            FormatString(ArrayCount(Text), Text,
                         ...
                         AssetsMode->StoredHeader.AssetCount, AssetsMode->StoredHeader.SizeOfStoredAsset,
                         (AssetsMode->StoredHeader.Version >> 24) & 0xFF, (AssetsMode->StoredHeader.Version >> 16) & 0xFF,
                         (AssetsMode->StoredHeader.Version >> 8) & 0xFF, AssetsMode->StoredHeader.Version & 0xFF);
            UILabel(Layout, Text, 933.0f);
...
internal void
EndUI(editor_state *EditorState, ui_state *UIState, editor_input *Input)
{
    TIMED_FUNCTION();
