#if !defined(ENGINE_PLATFORM_NUKLEAR_H)
/* ========================================================================
   $File: $
   $Date: 2024 $
   $Revision: $
...
#if 0
struct platform_nk_window
{
    // WINDOW
    platform_nk_window_find *Find;
    platform_nk_window_get_bounds *GetBounds;
    platform_nk_window_get_position *GetPosition;
    platform_nk_window_get_size *GetSize;
    platform_nk_window_get_width *GetWidth;
    platform_nk_window_get_height *GetHeight;
    platform_nk_window_get_panel *GetPanel;
    platform_nk_window_get_content_region *GetContentRegion;
    platform_nk_window_get_content_region_min *GetContentRegionMin;
    platform_nk_window_get_content_region_max *GetContentRegionMax;
    platform_nk_window_get_content_region_size *GetContentRegionSize;
    platform_nk_window_get_canvas *GetCanvas;
    platform_nk_window_get_scroll *GetScroll;
    platform_nk_window_has_focus *HasFocus;
    platform_nk_window_is_hovered *IsHovered;
    platform_nk_window_is_collapsed *IsCollapsed;
    platform_nk_window_is_closed *IsClosed;
    platform_nk_window_is_hidden *IsHidden;
    platform_nk_window_is_active *IsActive;
    platform_nk_window_is_any_hovered *IsAnyHovered;
    platform_nk_window_set_bounds *SetBounds;
    platform_nk_window_set_position *SetPosition;
    platform_nk_window_set_size *SetSize;
    platform_nk_window_set_focus *SetFocus;
    platform_nk_window_set_scroll *SetScroll;
    platform_nk_window_close *Close;
    platform_nk_window_collapse *Collapse;
    platform_nk_window_collapse_if *CollapseIf;
    platform_nk_window_show *Show;
    platform_nk_window_show_if *ShowIf;
};

struct platform_nk_layout
{
    // LAYOUT
    platform_nk_layout_set_min_row_height *SetMinRowHeight;
    platform_nk_layout_reset_min_row_height *ResetMinRowHeight;
    platform_nk_layout_widget_bounds *WidgetBounds;
    platform_nk_layout_ratio_from_pixel *RatioFromPixel;
    platform_nk_layout_row_dynamic *RowDynamic;
    platform_nk_layout_row_static *RowStatic;
    platform_nk_layout_row_begin *RowBegin;
    platform_nk_layout_row_push *RowPush;
    platform_nk_layout_row_end *RowEnd;
    platform_nk_layout_row *Row;
    platform_nk_layout_row_template_begin *RowTemplateBegin;
    platform_nk_layout_row_template_push_dynamic *RowTemplatePushDynamic;
    platform_nk_layout_row_template_push_variable *RowTemplatePushVariable;
    platform_nk_layout_row_template_push_static *RowTemplatePushStatic;
    platform_nk_layout_row_template_end *RowTemplateEnd;
    platform_nk_layout_space_begin *SpaceBegin;
    platform_nk_layout_space_push *SpacePush;
    platform_nk_layout_space_end *SpaceEnd;
    platform_nk_layout_space_bounds *SpaceBounds;
    platform_nk_layout_space_to_screen *SpaceToScreen;
    platform_nk_layout_space_to_local *SpaceToLocal;
    platform_nk_layout_space_rect_to_screen *SpaceRectToScreen;
    platform_nk_layout_space_rect_to_local *SpaceRectToLocal;
    platform_nk_spacer *Spacer;
};

struct platform_nk_group
{
    // GROUP
    platform_nk_group_begin *Begin;
    platform_nk_group_begin_titled *BeginTitled;
    platform_nk_group_end *End;
    platform_nk_group_scrolled_offset_begin *ScrolledOffsetBegin;
    platform_nk_group_scrolled_end *ScrolledEnd;
    platform_nk_group_get_scroll *GetScroll;
    platform_nk_group_set_scroll *SetScroll;
};

struct platform_nk_tree
{
    // TREE
    platform_nk_tree_push_hashed *PushHashed;
    platform_nk_tree_image_push_hashed *ImagePushHashed;
    platform_nk_tree_pop *Pop;
    platform_nk_tree_state_push *StatePush;
    platform_nk_tree_state_image_push *StateImagePush;
    platform_nk_tree_state_pop *StatePop;
    platform_nk_tree_element_push_hashed *ElementPushHashed;
    platform_nk_tree_element_image_push_hashed *ElementImagePushHashed;
    platform_nk_tree_element_pop *ElementPop;
};

#define NkTreePush(ui, ctx, type, title, state) ui.Tree.PushHashed(ctx, type, title, state, NK_FILE_LINE, ui.String.Len(NK_FILE_LINE),__LINE__)
#define NkTreePushID(ui, ctx, type, title, state, id) ui.Tree.PushHashed(ctx, type, title, state, NK_FILE_LINE,nk_strlen(NK_FILE_LINE),id)
#define NkTreeImagePush(ui, ctx, type, img, title, state) ui.Tree.ImagePushHashed(ctx, type, img, title, state, NK_FILE_LINE,ui.String.Len(NK_FILE_LINE),__LINE__)
#define NkTreeImagePushID(ui, ctx, type, img, title, state, id) ui.Tree.ImagePushHashed(ctx, type, img, title, state, NK_FILE_LINE,ui.String.Len(NK_FILE_LINE),id)
...
struct _nk_ui
{
    ...
    platform_nk_window Window;
    platform_nk_layout Layout;
...
#define ENGINE_PLATFORM_NUKLEAR_H
#endif
