#if !defined(EDITOR_DEBUG_INTERFACE_H)
/* ========================================================================
   $File: $
   $Date: 2024 $
   $Revision: $
...
struct debug_table;
#define DEBUG_EDITOR_FRAME_END(name) void name(editor_memory *Memory, editor_input *Input, editor_render_commands *RenderCommands)
...
#define EDITOR_DEBUG_INTERFACE_H
#endif
