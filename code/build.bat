...
set CommonLinkerFlags= -incremental:no -opt:ref user32.lib gdi32.lib  opengl32.lib glew32.lib glfw3.lib
...
cl %CommonCompilerFlags% ..\code\win32_engine_glfw.cpp -Fmwin32_engine.map /link %CommonLinkerFlags%
