#if !defined(SPELLWEAVER_PLATFORM_H)
/* ========================================================================
   $File: $
   $Date: 2024 $
   $Revision: $
...
typedef struct game_controller_input
{
    ...
    union
    {
        ...
        struct
        {
            ...
            game_button_state ChangeSphereToWater;
            game_button_state ChangeSphereToWind;
            game_button_state ChangeSphereToFire;
            ...
            game_button_state PlayMusic;
            game_button_state TerminateSound;
